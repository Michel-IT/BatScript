@echo off
title Ottimizzazione Windows 11 per Gaming
echo Creazione script di ottimizzazioni Windows 11 per Gaming
...
:: Disattiva Core Isolation (Integrità della memoria)
:: ATTENZIONE: Migliora le prestazioni ma riduce la sicurezza del sistema
...
:: Disattivare la luce notturna e HDR
echo Configurazione impostazioni display...
...
:: Multitasking e ancoraggio finestre
reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced" /v "SnapAssist" /t REG_DWORD /d "0" /f

:: Disabilitare Core Isolation - Integrità della memoria
if "%DISABLE_CORE_ISOLATION%"=="1" (
    echo Disattivazione Core Isolation (Integrità della memoria)...
...
:: Abilitare pianificazione GPU con accelerazione hardware
